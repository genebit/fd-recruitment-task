...
export interface ITodoTagsClient {
    create(command: CreateTodoTagCommand): Observable<number>;
    update(id: number, command: UpdateTodoTagCommand): Observable<FileResponse>;
    delete(id: number): Observable<FileResponse>;
}
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["tags"])) {
                ...
                for (let item of _data["tags"])
                    this.tags!.push(TodoTag.fromJS(item));
            }
        }
    }
...
export class TodoTag extends BaseAuditableEntity implements ITodoTag {
    ...
    override init(_data?: any) {
        ...
        if (_data) {
            this.tag = _data["tag"];
            if (Array.isArray(_data["todoItemTags"])) {
                this.todoItemTags = [] as any;
                for (let item of _data["todoItemTags"])
                    this.todoItemTags!.push(TodoItemTag.fromJS(item));
            }
        }
    }
    ...
    override toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["tag"] = this.tag;
        if (Array.isArray(this.todoItemTags)) {
            data["todoItemTags"] = [];
            for (let item of this.todoItemTags)
                data["todoItemTags"].push(item.toJSON());
        }
        super.toJSON(data);
        return data;
    }
...
export class TodoItemTag implements ITodoItemTag {
    itemId?: number;
    item?: TodoItem;
    tagId?: number;
    tag?: TodoTag;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.tag = _data["tag"] ? TodoTag.fromJS(_data["tag"]) : <any>undefined;
        }
    }

    static fromJS(data: any): TodoItemTag {
        data = typeof data === 'object' ? data : {};
...
export class UpdateTodoTagCommand implements IUpdateTodoTagCommand {
    id?: number;
    tag?: string | undefined;

    constructor(data?: IUpdateTodoTagCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateTodoTagCommand {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateTodoTagCommand();
        result.init(data);
        return result;
    }
...
export interface IUpdateTodoTagCommand {
    id?: number;
    tag?: string | undefined;
}
